...
# ── INTRO SCREEN (pure Python + time.sleep) ──────────────────────────────────
if not st.session_state.logado and not st.session_state.intro_vista:
    import time
    import streamlit.components.v1 as _components
    st.markdown("""
    <style>
    .stApp { background: linear-gradient(160deg,#fffef5 0%,#fdf6e3 50%,#f5e8b0 100%) !important; }
